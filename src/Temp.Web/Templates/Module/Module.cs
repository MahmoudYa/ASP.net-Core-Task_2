...
public class Module : GennyModule
{
    ...
    public override void Run()
    {
        ...
        {
            { $"../Temp.Services/{shortPath}{Model}Service.cs", Scaffold("Services/Service") },
            { $"../Temp.Validators/{shortPath}{Model}Validator.cs", Scaffold("Validators/Validator") },
            { $"../Temp.Controllers/{shortPath}{Controller}.cs", Scaffold("Controllers/Controller") },
            { $"../../test/Temp.Tests/Integration/Controllers/{shortPath}{Controller}Tests.cs", Scaffold("Tests/ControllerTests") },

            { $"../Temp.Web/Views/{path}/Index.cshtml", Scaffold("Web/Index") },
            { $"../Temp.Web/Views/{path}/Create.cshtml", Scaffold("Web/Create") },
            { $"../Temp.Web/Views/{path}/Details.cshtml", Scaffold("Web/Details") },
            { $"../Temp.Web/Views/{path}/Edit.cshtml", Scaffold("Web/Edit") },
            { $"../Temp.Web/Views/{path}/Delete.cshtml", Scaffold("Web/Delete") }
        };

        foreach (String view in model.ViewProperties.Keys.Where(key => key.Length == 0 || model.Views[key] != model.Views[""]))
            results[$"../Temp.Web/Resources/Views/{path}/{Model}{view}View.json"] = Scaffold($"Resources/{view}View");

        foreach (Type type in model.EnumTypes)
            results[$"../Temp.Web/Resources/Enums/{path}/{type.Name}.json"] = Scaffold("Resources/Enum", Enum.GetNames(type));

        if (!File.Exists($"../Temp.Objects/Models/{path}/{Model}.cs") ||
            !File.Exists($"../Temp.Objects/Views/{path}/{Model}View.cs"))
            results = new Dictionary<String, GennyScaffoldingResult>
            {
                { $"../Temp.Objects/Models/{path}/{Model}.cs", Scaffold("Objects/Model") },
                { $"../Temp.Objects/Views/{path}/{Model}View.cs", Scaffold("Objects/View") }
            };
    ...
    private void AddArea()
    {
        ...
        Logger.Write("../Temp.Controllers/Area.cs - ");

        String content = File.ReadAllText("../Temp.Controllers/Area.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../Temp.Controllers/Area.cs", content);
    ...
    {
        Logger.Write("../Temp.Web/mvc.sitemap - ");
    ...
    {
        Logger.Write("../Temp.Data/Migrations/Configuration.cs - ");

        String content = File.ReadAllText("../Temp.Data/Migrations/Configuration.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../Temp.Data/Migrations/Configuration.cs", content);
    ...
    {
        Logger.Write("../Temp.Web/Views/_ViewImports.cshtml - ");

        String content = File.ReadAllText("../Temp.Web/Views/_ViewImports.cshtml");
        String[] imports = Regex.Matches(content, "@using (.+);").Select(match => match.Value).ToArray();
        String[] newImports = imports
            .Append(Area == null ? "@using Temp.Controllers;" : $"@using Temp.Controllers.{Area};")
            .Distinct()
        ...
        else
        {
            ...
            File.WriteAllText("../Temp.Web/Views/_ViewImports.cshtml", content);
    ...
    {
        Logger.Write("../../test/Temp.Tests/Helpers/ObjectsFactory.cs - ");

        String content = File.ReadAllText("../../test/Temp.Tests/Helpers/ObjectsFactory.cs");
        ModuleModel model = new(Model!, Controller!, Area);
        ...
        else
        {
            ...
            File.WriteAllText("../../test/Temp.Tests/Helpers/ObjectsFactory.cs", newContent);
    ...
    {
        Logger.Write("../../test/Temp.Tests/Unit/Data/Migrations/ConfigurationTests.cs - ");

        String content = File.ReadAllText("../../test/Temp.Tests/Unit/Data/Migrations/ConfigurationTests.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/Temp.Tests/Unit/Data/Migrations/ConfigurationTests.cs", content);
    ...
    {
        Logger.Write("../../test/Temp.Tests/Helpers/TestingContext.cs - ");

        String content = File.ReadAllText("../../test/Temp.Tests/Helpers/TestingContext.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/Temp.Tests/Helpers/TestingContext.cs", content);
    ...
    {
        Logger.Write($"../Temp.Web/Resources/Shared/{resource}.json - ");
